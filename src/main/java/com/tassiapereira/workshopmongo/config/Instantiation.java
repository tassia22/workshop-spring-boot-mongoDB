...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/02/2024"), "partiu viagem", "vou viajar para o nordeste, abracos", maria);
		Post post2 = new Post(null, sdf.parse("23/02/2024"), "bom dia", "hoje eu acordei animado", maria);
